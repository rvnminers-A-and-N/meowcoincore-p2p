...
function builder(options) {
  ...
  if (!options.network) {
    options.network = meowcoincore.Networks.defaultNetwork;
  }

  options.Block = options.Block || meowcoincore.Block;
  options.BlockHeader = options.BlockHeader || meowcoincore.BlockHeader;
  options.Transaction = options.Transaction || meowcoincore.Transaction;
  options.MerkleBlock = options.MerkleBlock || meowcoincore.MerkleBlock;
