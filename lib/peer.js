 ...
 * using the standard Meowcoin protocol. A Peer instance represents one connection
 * on the Meowcoin network. To create a new peer connection provide the host and port
