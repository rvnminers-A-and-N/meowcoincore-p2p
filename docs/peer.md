# Peer
Represents a node from the p2p meowcoin network. The Peer class supports connecting directly to other nodes or through a socks5 proxy like Tor.
...
```javascript
var p2p = require('meowcoincore-p2p')
var Peer = p2p.Peer;
